...
class FindPackage:
    ...
    def QExploration(self, epoches: int, gamma: float = 0.9) -> None:
        ...
        while not goal_state_isReached:
            ...
            if epoches > 1:
                if self.prev_gridCell[0] != gridCell and collected_packages is None and current_num_packages < 3:
                    break
                if self.prev_gridCell[1] != gridCell and collected_packages == 1 and gridCell > 0:
                    break
...
def main():
    ...
    fourRoomsObj.showPath(-1, "./Images/scenario2.png")
    print("Done !!!")
    print("Picture saved, check ./Images/scenario2.png")
