...
class MNIST:
   ...
   """
    ...
    def save_model(self, path: str = "Models/classifier_2.pt"):
    ...
    * Add batch parameter
    ...
    def get_model(self, path: str = "Models/classifier_2.pt"):
        model = NeuralNetwork()
    ...
    """
    - Execute method and take user commands
    :except - raised when user enter incorrect image name  
    """
    def main(self):
